...
<body ng-controller="appCtrl">
    <h2 class="text-center">Flint groups</h2> 
    <div>
    ...
    <div class="modal fade" id="joinTIN" tabindex="-1" role="dialog" aria-labelledby="joinTINTitle" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <h5 class="modal-title" id="joinTINTitle">JOIN TIN</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
            </div>
    ...
    <div class="mt-2 bg-light"><b>Current period : </b> {{period_F}}</div>
    <table class="table table-bordered mt-2 mimtable">
        ...
        <tbody>
            <tr ng-repeat="item in flintPart track by item.period">
                <td>{{item.period}}</td>
                <td>{{item.price}}</td>
                <td>{{item.number}}</td>
                <td>
        ...
        <tfoot>
            <tr>
                <td class="text-center" ng-click="goTo('more/flint')" colspan="4">
    ...
    <table class="table table-bordered mimtable" ng-show="navigateOrder == 0">
        ...
        <tbody>
            <tr ng-repeat="item in currentOrderF track by $index">
                <td>
                    {{item.numOrder}}
                </td>
                <td>
    ...
    <table class="table table-bordered mimtable" ng-show="navigateOrder == 1">
        ...
        <tbody>
            <tr ng-repeat="item in historyOrderF track by $index">
                <td>
                    {{item.numOrder}}
                </td>
                <td>
