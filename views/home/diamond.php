...
<body ng-controller="appCtrl">
    <h2 class="text-center">Diamond groups</h2> 
    <div>
    ...
    <div class="mt-2 bg-light"><b>Current period : </b>{{period_D}}</div>
    <table class="table table-bordered mt-2 mimtable">
        ...
        <tbody>
            <tr ng-repeat="item in diamondPart track by item.period">
                <td>{{item.period}}</td>
                <td>{{item.price}}</td>
                <td>{{item.number}}</td>
                <td>
        ...
        <tfoot>
            <tr>
                <td class="text-center" ng-click="goTo('more/diamond')" colspan="4">
    ...
    <table class="table table-bordered mimtable" ng-show="navigateOrder == 0">
        ...
        <tbody>
            <tr ng-repeat="item in currentOrderD track by $index">
                <td>
                    {{item.numOrder}}
                </td>
                <td>
    ...
    <table class="table table-bordered mimtable" ng-show="navigateOrder == 1">
        ...
        <tbody>
            <tr ng-repeat="item in historyOrderD track by $index">
                <td>
                    {{item.numOrder}}
                </td>
                <td>
