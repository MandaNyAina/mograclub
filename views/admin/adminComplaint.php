...
<body ng-controller="adminCtrl">
    ...
    <div ng-if="item.parent.solved == 0" style="border: 1px solid grey;" class="p-3 bg-light mt-3" ng-repeat="item in responseAll track by $index">
            <b>Ticket ID :</b> <span ng-bind="item.parent.ticket_id"></span> <br>
            <b>Date :</b> <span ng-bind="item.parent.date"></span><span ng-bind="item.parent.time"></span> <br>
            <b>Type :</b> <span ng-bind="item.parent.message_type"></span> <br>
            <b>Details :</b> <span ng-bind="item.parent.message"></span> <br>
            <b>Status :</b> <span ng-bind="item.parent.solved | solving"></span> <br>
            Response (<span ng-bind="item.response.length"></span>) <input type="checkbox" name="" id="" ng-model="interpretation[$index + 'A']">
            <div ng-if="interpretation[$index + 'A']" style="background-color: white;margin-left: 10%;border-radius: 10px" class="p-3 mt-2">
                ...
                <div ng-repeat="res in item.response track by $index">
                    ...
                    <span ng-if="res.id_user != '<?php echo $_SESSION["user_loggeg"]["id"] ?>'"><?php echo "<span ng-bind='res.id_user'></span>" ?></span> <br>
                    <b>Response :</b> <br>
                        <span ng-bind="res.message"></span>
                    <hr>
                </div>
            </div>
        </div>
